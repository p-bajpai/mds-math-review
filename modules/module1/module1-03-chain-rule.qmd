...
## Video 3 (Max and Min and Second Derivative)

This video discusses the basics of using calculus to find maximum and minimum values of one-variable functions. These ideas will be expanded on in the next module to optimization for multivariate functions.
